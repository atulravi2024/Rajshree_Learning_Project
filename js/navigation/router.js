...
function showMainCategory(titleCat) {
    ...
    if (titleCat === 'varnamala') {
        ...
        container.innerHTML = createChoiceCard('👨‍👩‍👧‍👦', 'मेरा परिवार', 'family_main') + createChoiceCard('🦁', 'पशु-पक्षी', 'animals_main') + createChoiceCard('🥦', 'फल-सबी', 'fruits_main') + createChoiceCard('✨', 'अच्छी आदतें', 'habits_main');
