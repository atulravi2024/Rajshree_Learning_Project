...
memory/
├── 01 Current State/
│   ├── 01.05_PROJECT_MEMORY.md           ← 🔴 Core rules (always)
│   ├── 01.01_PROJECT_HTML.md             ← 🟡 HTML structure
│   ├── 01.02_PROJECT_CSS.md              ← 🟡 CSS structure
│   ├── 01.03_PROJECT_JS.md               ← 🟡 JS modules
│   ├── 01.04_PROJECT_ASSETS.md           ← 🟡 Audio & files
│   └── 01.06_PROJECT_CHANGELOG.md        ← 🟢 Archive
└── 02 Research & Knowledge/
    └── 02.03_Roadmap/
        └── 02.03_AGE_THEMES.md       ← This file
```
