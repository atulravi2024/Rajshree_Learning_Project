...
window.RAJSHREE_DATA.swar = [
    { letter: 'अ', word: 'अनार', emoji: '🍎', value: 'अ', audio: 'varnamala/swar/v_a_anar.mp3', textOnly: false },
    { letter: 'आ', word: 'आम', emoji: '🥭', value: 'आ', audio: 'varnamala/swar/v_aa_aam.mp3', textOnly: false },
    { letter: 'इ', word: 'इमली', emoji: '🍬', value: 'इ', audio: 'varnamala/swar/v_i.mp3', textOnly: false },
    { letter: 'ई', word: 'ईख', emoji: '🎋', value: 'ई', audio: 'varnamala/swar/v_ee.mp3', textOnly: false },
