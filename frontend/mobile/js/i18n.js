...
window.RAJSHREE_I18N = {
    translations: {
        'hi': {
            ...
            'status_on': 'शुरू',
            'status_off': 'बंद',
            'msg_settings_locked_child_lock': 'चाइल्ड लॉक सक्रिय है: सेटिंग्स लॉक हैं',
            'math_title': 'सुरक्षा जांच',
            'math_desc': 'चाइल्ड लॉक को बंद करने के लिए हल करें:',
            'math_wrong': 'गलत उत्तर! फिर से कोशिश करें',
            'math_success': 'सफलता!',
        ...
        'en': {
            ...
            'status_on': 'ON',
            'status_off': 'OFF',
            'msg_settings_locked_child_lock': 'Child Lock Active: Settings Locked',
            'math_title': 'Security Check',
            'math_desc': 'Solve to disable Child Lock:',
            'math_wrong': 'Wrong Answer! Try Again',
            'math_success': 'Check Passed!',
            // Alerts & Confirmations
